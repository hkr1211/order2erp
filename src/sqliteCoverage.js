...
export const SQLITE_PAGE_DEPENDENCIES = [
  ...
  { page_name: "物料控制中心", page_path: "/materials", tables: ["erp_material_alerts", "erp_warehouses", "erp_inventory_summary", "erp_inventory_details"], missing_sources: ["BOM展开", "采购在途", "90天出入库流水"] },
  { page_name: "生产进度中心", page_path: "/production", tables: ["erp_procedure_plans", "erp_process_reports"], missing_sources: ["领料历史", "BOM本地表"] },
  { page_name: "派工进度追踪", page_path: "/dispatch", tables: ["erp_procedure_plans", "erp_process_reports"], missing_sources: ["设备状态"] },
